...
schemaPaths=$(cd "$scriptDir../../json-schema/gen-schema-json" && find . -name "*.json")
schemaPathsAbsolute=""
schemaOutput=""
...
echo ''
~/go/bin/go-jsonschema -t -p genjsonschema $schemaOutput $scriptDir../../json-schema/gen-schema-json/Main.json
