...
class TestLLMClient:
    ...
    def test_create_openai_model(self, mock_chat_openai):
        ...
        mock_chat_openai.assert_called_once_with(
            model="gpt-4", temperature=0.3, max_tokens=800, timeout=30
        )
    ...
    def test_create_gpt35_model(self, mock_chat_openai):
        ...
        assert client.model == mock_model
        mock_chat_openai.assert_called_once_with(
            model="gpt-3.5-turbo", temperature=0.3, max_tokens=800, timeout=30
        )
    ...
    def test_create_claude_model(self, mock_chat_anthropic):
        ...
        mock_chat_anthropic.assert_called_once_with(
            model="claude-3-5-sonnet-20241022", temperature=0.3, max_tokens=800, timeout=30
        )
    ...
    def test_create_claude_sonnet_4_model(self, mock_chat_anthropic):
        ...
        assert client.model == mock_model
        mock_chat_anthropic.assert_called_once_with(
            model="claude-sonnet-4-0", temperature=0.3, max_tokens=800, timeout=30
        )
