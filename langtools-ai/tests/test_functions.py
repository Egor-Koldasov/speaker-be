...
from langtools.ai.functions import generate_dictionary_entry, ValidationError, LLMAPIError
from langtools.ai.models import DictionaryEntryParams, ModelType, AiDictionaryEntry, Meaning
...
class TestGenerateDictionaryEntry:
    ...
    async def test_empty_meanings_validation(self, mock_create_chain, mock_client_class):
        ...
        result_no_meanings = AiDictionaryEntry(
            source_language="ru",
            meanings=[]
        )
